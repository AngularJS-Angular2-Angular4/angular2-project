...
public class ShoppingCart {
     ...
     *
     * @return a new list of {@link com.centurylink.pctl.mod.cart.domain.ShoppingCart.LineItem} representing the state of the shopping cart
    ...
    /**
     * Incorporates a new {@link com.centurylink.pctl.mod.cart.domain.ShoppingCart.CartEvent} and updated the shopping cart
     *
     * @param cartEvent is the {@link com.centurylink.pctl.mod.cart.domain.ShoppingCart.CartEvent} that will alter the state of the cart
     * @return the state of the {@link ShoppingCart} after applying the new {@link com.centurylink.pctl.mod.cart.domain.ShoppingCart.CartEvent}
     */
    ...
    /**
     * Determines whether or not the {@link com.centurylink.pctl.mod.cart.domain.ShoppingCart.CartEvent} is a terminal event, causing the
