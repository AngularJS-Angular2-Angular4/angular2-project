...
import com.centurylink.pctl.mod.auth.domain.security.Filter.*;
import com.centurylink.pctl.mod.auth.domain.security.endpoint.JwtAuthenticationEntryPoint;
...
*/
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
        resources.resourceId("pctl.mod.auth");
    }
