package com.centurylink.pctl.mod.user.domain.security.utils;

/**
 * Created by begin.samuel on 10/6/2016.
 */
import com.centurylink.pctl.mod.user.domain.security.config.AuthoritiesConstants;
import com.centurylink.pctl.mod.user.domain.security.model.CustomUserDetails;
