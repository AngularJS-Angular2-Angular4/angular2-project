package com.centurylink.pctl.mod.notification.domain.security.config;

import com.centurylink.pctl.mod.notification.domain.security.Filter.*;
import com.centurylink.pctl.mod.notification.domain.security.endpoint.JwtAuthenticationEntryPoint;
...
@Configuration
@EnableWebSecurity
@EnableMongoRepositories("com.centurylink.pctl.mod.notification.domain")
